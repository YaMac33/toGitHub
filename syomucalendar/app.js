(function () {
  ...
  function renderRoute() {
    var isHistory = window.location.hash === "#history";
    state.elements.calendarScreen.hidden = isHistory;
    state.elements.historyScreen.hidden = !isHistory;
    state.elements.calendarViewLink.classList.toggle("active", !isHistory);
    state.elements.historyViewLink.classList.toggle("active", isHistory);
    if (!isHistory && state.calendar) {
      setTimeout(function () {
  ...
  function scrollToOverviewDate(date) {
    state.elements.overviewDetails.open = true;
    setTimeout(function () {
